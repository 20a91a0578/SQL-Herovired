...
-- );
-- insert into FootballVenue values(2001,'Italy',101,10000);
-- insert into FootballVenue values(2002,'USA',102,15000);
-- insert into FootballVenue values(2003,'France',103,12000);
